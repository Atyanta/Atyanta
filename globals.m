...
% opt.mot2d_train_seqs = {'TUD-Campus', 'PETS09-S2L1', ...
%     'ETH-Bahnhof', 'ETH-Sunnyday', 'ETH-Pedcross2', 'ADL-Rundle-6', ...
%     'ADL-Rundle-8', 'KITTI-13', 'KITTI-17', 'Venice-2'};
% opt.mot2d_train_nums = [71, 795, 1000, 354, 837, 525, 654, 340, 145, 600];
...
%addpath(char(strcat(opt.root,'\3rd_party\libsvm-3.20\matlab')));
addpath(char(strcat(opt.root,'\3rd_party\Hungarian')));
