...
switch title
    case 'Dipilih'
        ...
        numzeros	= 8;		%number of digits for the frame index
        start_frame = 7498;		% first frame index to be tracked
        nframes		= 179;		% harusnya =122 totals number of frames to be tracked
        ...
        %         | 				|	        
        %   p2(50,297)--------------
        init_pos= [200,297,197;
                   54,50,98];
        sz_T =[20,12];      % size of template    
end
